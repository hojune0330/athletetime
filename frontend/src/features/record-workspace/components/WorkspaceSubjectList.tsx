  ...
  return (
    <section className="border border-line bg-surface" aria-labelledby="workspace-subjects-title">
      <div className="border-b border-line px-4 py-3">
        <p className="font-mono text-[11px] font-semibold tracking-wide text-brand">선택한 선수</p>
        <h2 id="workspace-subjects-title" className="mt-1 text-body font-semibold text-ink">모음에 담은 선수</h2>
      ...
      <ul>
        ...
        {unavailableSubjectKeys.map((subjectKey) => (
          <li key={subjectKey} className="flex items-center gap-3 border-b border-hair px-4 py-3 last:border-b-0">
            <div className="min-w-0 flex-1">
              <p className="text-body-sm font-semibold text-ink">선택한 선수를 불러오지 못했어요</p>
